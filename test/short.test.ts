...
test('snakeCase    (spaces)', () => expect(   snakeCase('Cats? & Dogs!')).toEqual('cats_dogs')) // prettier-ignore
test('constantCase (spaces)', () => expect(constantCase('Cats? & Dogs!')).toEqual('CATS_DOGS')) // prettier-ignore
test('adaCase      (spaces)', () => expect(     adaCase('Cats? & Dogs!')).toEqual('Cats_Dogs')) // prettier-ignore
...
test('camelCase    (keepSpecialCharacters)', () => expect(   camelCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
test('pascalCase   (keepSpecialCharacters)', () => expect(  pascalCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CatベルギーDogうちゅう')) // prettier-ignore
test('kebabCase    (keepSpecialCharacters)', () => expect(   kebabCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
test('snakeCase    (keepSpecialCharacters)', () => expect(   snakeCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
test('constantCase (keepSpecialCharacters)', () => expect(constantCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CATベルギーDOGうちゅう')) // prettier-ignore
test('adaCase      (keepSpecialCharacters)', () => expect(     adaCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CatベルギーDogうちゅう')) // prettier-ignore
test('cobolCase    (keepSpecialCharacters)', () => expect(   cobolCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CATベルギーDOGうちゅう')) // prettier-ignore
test('trainCase    (keepSpecialCharacters)', () => expect(   trainCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CatベルギーDogうちゅう')) // prettier-ignore
test('dotNotation  (keepSpecialCharacters)', () => expect( dotNotation('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
test('pathCase     (keepSpecialCharacters)', () => expect(    pathCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本cat/ベルギーdog/うちゅう')) // prettier-ignore
test('spaceCase    (keepSpecialCharacters)', () => expect(   spaceCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
test('capitalCase  (keepSpecialCharacters)', () => expect( capitalCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CatベルギーDogうちゅう')) // prettier-ignore
test('upperCase    (keepSpecialCharacters)', () => expect(   upperCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本CATベルギーDOGうちゅう')) // prettier-ignore
test('lowerCase    (keepSpecialCharacters)', () => expect(   lowerCase('日本catベルギーdogうちゅう', { keepSpecialCharacters: true })).toEqual('日本catベルギーdogうちゅう')) // prettier-ignore
