...
// V1
// test('camelCase    (spaces short)', (t) => t.is(   camelCase('Cats & Dogs'), 'ERROR')) // prettier-ignore
// test('pascalCase   (spaces short)', (t) => t.is(  pascalCase('Cats & Dogs'), 'ERROR')) // prettier-ignore
